    ...
    <div style={{ minHeight: '100vh', background: '#ffffff', color: '#0f172a', fontFamily: 'var(--font-sans)', display: 'flex', flexDirection: 'column' }}>
      <main style={{ flex: 1, maxWidth: '1000px', width: '100%', margin: '0 auto', padding: '40px 24px 80px' }}>
        ...
        <section style={{ marginBottom: '60px' }}>
          <h2 style={{ fontSize: '26px', fontWeight: 800, color: '#0f172a', marginBottom: '16px', letterSpacing: '-0.5px' }}>
            Our Campus Mission
          </h2>
          <p style={{ fontSize: '16px', color: '#334155', lineHeight: 1.8, margin: '0 0 16px 0' }}>
        ...
        {/* Feature Grid */}
        <section style={{ marginBottom: '60px' }}>
          <h2 style={{ fontSize: '26px', fontWeight: 800, color: '#0f172a', marginBottom: '28px', letterSpacing: '-0.5px' }}>
        ...
        <section style={{ background: '#f8fafc', padding: '36px', borderRadius: '24px', border: '1px solid #f1f5f9', marginBottom: '60px' }}>
          <h2 style={{ fontSize: '24px', fontWeight: 800, color: '#0f172a', marginBottom: '24px', textAlign: 'center' }}>
            How Losify Works Step-by-Step
          </h2>

          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '20px' }}>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '14px', fontWeight: 900, color: '#2563eb', background: '#ffffff', width: '36px', height: '36px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 12px', border: '2px solid #bfdbfe' }}>
                1
              </div>
              <h4 style={{ fontSize: '15px', fontWeight: 800, color: '#0f172a', margin: '0 0 6px 0' }}>Report Item</h4>
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <h4 style={{ fontSize: '15px', fontWeight: 800, color: '#0f172a', margin: '0 0 6px 0' }}>AI Visual Scan</h4>
              <p style={{ fontSize: '13px', color: '#64748b', margin: 0, lineHeight: 1.5 }}>
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <h4 style={{ fontSize: '15px', fontWeight: 800, color: '#0f172a', margin: '0 0 6px 0' }}>HOD Verification</h4>
              <p style={{ fontSize: '13px', color: '#64748b', margin: 0, lineHeight: 1.5 }}>
        ...
        <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <Link href="/report/lost" prefetch={true} style={{ padding: '14px 28px', background: '#ffffff', color: '#0f172a', border: '1.5px solid #cbd5e1', borderRadius: '12px', fontWeight: 800, fontSize: '14px', textDecoration: 'none' }}>
            + Report Lost Item
          </Link>
        </div>
      </main>
